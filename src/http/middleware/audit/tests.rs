...
async fn test_token_not_present() {
    ...
    assert_failed_with_message(response, "token-not-present");
}
...
fn assert_failed_with_message(response: Result<ServiceResponse, Error>, message: &str) {
